...
final class Version20210413015014 extends AbstractMigration
{
	...
	public function down(Schema $schema): void
	{
		...
		$this->addSql('ALTER TABLE project_ignored_page ADD CONSTRAINT FK_E2EE346166D1F9C FOREIGN KEY (project_id) REFERENCES project (id) ON UPDATE NO ACTION ON DELETE CASCADE');
		$this->addSql('ALTER TABLE project_ignored_page ADD CONSTRAINT FK_E2EE346C4663E4 FOREIGN KEY (page_id) REFERENCES page (id) ON UPDATE NO ACTION ON DELETE CASCADE');
		$this->addSql('ALTER TABLE project_page ADD CONSTRAINT FK_2D9B7E38166D1F9C FOREIGN KEY (project_id) REFERENCES project (id) ON UPDATE NO ACTION ON DELETE CASCADE');
		$this->addSql('ALTER TABLE project_page ADD CONSTRAINT FK_2D9B7E38C4663E4 FOREIGN KEY (page_id) REFERENCES page (id) ON UPDATE NO ACTION ON DELETE CASCADE');
