...
final class Version20210408013428 extends AbstractMigration
{
	...
	public function up(Schema $schema): void
	{
		...
		$this->addSql('CREATE TABLE tool_response (id INT AUTO_INCREMENT NOT NULL, tool VARCHAR(255) NOT NULL, url VARCHAR(1024) NOT NULL, date_received DATETIME NOT NULL, processing_time INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
