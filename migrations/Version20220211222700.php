...
final class Version20220211222700 extends AbstractMigration
{
	...
	public function up(Schema $schema): void
	{
		...
		$this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526CE2904019 FOREIGN KEY (thread_id) REFERENCES comment (id) ON DELETE CASCADE');
		$this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526C7E0892A4 FOREIGN KEY (checklist_item_id) REFERENCES item (id) ON DELETE CASCADE');
	}
