	...
	static get styles()
	{
		return [
			...
			css`
				...
				.button { display: flex; width: 100%; justify-content: center; align-items: center; padding: 16px 30px; margin: 0; font-family: inherit; font-size: .85rem; font-weight: 600; line-height: 1.3; text-decoration: none; text-align: center; color: var(--button-text-color, #fff); background-color: var(--button-bg-color, #2751e6); border: none; border-radius: 13px; box-shadow: 0 2px 10px 0 rgba(var(--shadow-rgb, "0, 0, 0"), .15); box-sizing: border-box; cursor: pointer; transition: background .25s ease, box-shadow .25s ease; }
