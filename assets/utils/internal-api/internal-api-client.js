import InternalApiError from "./internal-api-error.js";

// @TODO: Add CSRF and/or session checks to API calls

/**
  * The `InternalApiClient` class handles all requests made to the internal Koalati API.
  *
...
class InternalApiClient {
	 ...
	 * @param {string} endpoint The route name of the API endpoint.
	 * @param {object} body The body of the request. Raw objects and FormData are accepted.
	 * @param {InternalApiClient.ERROR_FLASH|function|null} errorCallback Specifies what to do when a user-friendly
	 * 	error message is returned by the API. Available options:
	 * 	- `InternalApiClient.ERROR_FLASH`: automatically displays the error in a temporary Flash message, and then throws an `InternalApiError`. (default)
	 * 	- function: calls the provided callback with the error message as a parameter.
	 *  - null: throws an `InternalApiError` without providing any user feedback.
	 ...
	 */
	async _request(method, endpoint, body = {}, errorCallback = InternalApiClient.ERROR_FLASH, abortController = null)
	{
		method = method.trim().toUpperCase();
		...
		try {
			...
			if (errorCallback == InternalApiClient.ERROR_FLASH) {
		...
		if (responseData.status != "ok") {
			...
			throw new InternalApiError(responseData.message);
		}
	 ...
	 * @param {InternalApiClient.ERROR_FLASH|function|null} errorCallback Specifies what to do when a user-friendly
	 * 	error message is returned by the API. Available options:
	 * 	- `ApiClient.ERROR_FLASH`: automatically displays the error in a temporary Flash message, and then throws an `InternalApiError`. (default)
	 * 	- function: calls the provided callback with the error message as a parameter.
	 *  - null: throws an `InternalApiError` without providing any user feedback.
	 * @param {AbortController|null} abortController The abort controller to use for the request (optional)
	 * @returns {object|undefined} The response data object, or undefined if an error is returned from the API.
	 * @throws {InternalApiError} Thrown when the API reutnrs an error and the `errorCallback` is not a function.
	 */
	get(endpoint, body = {}, errorCallback = InternalApiClient.ERROR_FLASH, abortController = null)
	{
	 ...
	 * @throws {InternalApiError} Thrown when the API reutnrs an error and the `errorCallback` is not a function.
	 */
	post(endpoint, body = {}, errorCallback = InternalApiClient.ERROR_FLASH, abortController = null)
	{
	 ...
	 * @throws {InternalApiError} Thrown when the API reutnrs an error and the `errorCallback` is not a function.
	 */
	put(endpoint, body = {}, errorCallback = InternalApiClient.ERROR_FLASH, abortController = null)
	{
	 ...
	 * @param {InternalApiClient.ERROR_FLASH|function|null} errorCallback Specifies what to do when a user-friendly
	 * 	error message is returned by the API. Available options:
	 * 	- `InternalApiClient.ERROR_FLASH`: automatically displays the error in a temporary Flash message, and then throws an `ApiError`. (default)
	 * 	- function: calls the provided callback with the error message as a parameter.
	 *  - null: throws an `InternalApiError` without providing any user feedback.
	 * @param {AbortController|null} abortController The abort controller to use for the request (optional)
	 * @returns {object|undefined} The response data object, or undefined if an error is returned from the API.
	 * @throws {InternalApiError} Thrown when the API reutnrs an error and the `errorCallback` is not a function.
	 */
	patch(endpoint, body = {}, errorCallback = InternalApiClient.ERROR_FLASH, abortController = null)
	{
	 ...
	 * @throws {InternalApiError} Thrown when the API reutnrs an error and the `errorCallback` is not a function.
	 */
	delete(endpoint, body = {}, errorCallback = InternalApiClient.ERROR_FLASH, abortController = null)
	{
