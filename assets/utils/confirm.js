 ...
 */
export default function confirm(content, confirmLabel = null, cancelLabel = null) {
	...
	return new Promise(resolve => {
		const modalContent = html`
			...
			<div class="button-container small right">
				...
				<nb-button color="blue" data-action="confirm" size="small">${confirmLabel ? confirmLabel : Translator.trans("generic.confirm")}</nb-button>
			</div>
		`;
